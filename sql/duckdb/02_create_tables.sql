...
CREATE SEQUENCE IF NOT EXISTS warehouse_comp_key_seq START 1;
CREATE SEQUENCE IF NOT EXISTS warehouse_season_key_seq START 1;
CREATE SEQUENCE IF NOT EXISTS warehouse_team_key_seq START 1;
CREATE SEQUENCE IF NOT EXISTS warehouse_venue_key_seq START 1;
CREATE SEQUENCE IF NOT EXISTS warehouse_match_key_seq START 1;

-- ================================================
-- DimCompetition
-- ================================================
CREATE TABLE warehouse.dim_competition(
    comp_key INTEGER PRIMARY KEY DEFAULT nextval('warehouse_comp_key_seq'),
...
CREATE TABLE warehouse.dim_season(
    season_key INTEGER PRIMARY KEY DEFAULT nextval('warehouse_season_key_seq'),
...
CREATE TABLE warehouse.dim_team(
    team_key INTEGER PRIMARY KEY DEFAULT nextval('warehouse_team_key_seq'),
...
CREATE TABLE warehouse.dim_venue(
    venue_key INTEGER PRIMARY KEY DEFAULT nextval('warehouse_venue_key_seq'),
...
CREATE TABLE warehouse.fact_match(
    match_key INTEGER PRIMARY KEY DEFAULT nextval('warehouse_match_key_seq'),
